// Credit to stickandgum for the formatting
...
#    undef ENABLE_RGB_MATRIX_BAND_PINWHEEL_SAT          // Single hue 3 blade spinning pinwheel fades
...
#    undef ENABLE_RGB_MATRIX_CYCLE_PINWHEEL             // Full cycling rainbow pinwheel
